...
const Timer = () => {
    const { timeLeft, setTimeLeft, selectedTimer, setSelectedTimer, resetGame, roundId } = useGame();
    ...
    return (
        <div className='max-w-md mx-auto shadow-2xl min-h-screen' >
            ...
            <div className="mt-2 relative w-full max-w-md mx-auto">
                ...
                {/* Overlay id texts */}
                <p className="absolute top-18 left-6 text-sm font-semibold text-white">{roundId}</p>
